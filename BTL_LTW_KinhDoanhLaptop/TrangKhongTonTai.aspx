<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrangKhongTonTai.aspx.cs"
    Inherits="BTL_LTW_KinhDoanhLaptop.TrangKhongTonTai" %>
            ...
            <header class="phan-dau-trang">
                <div class="noi-dung-phan-dau">
                    ...
                    <div class="cum-phai-header header-right">
                        ...
                        <div id="divDaDangNhap" runat="server" class="khu-vuc-tai-khoan account-area user-dropdown"
                            visible="false">
                            ...
                            <div class="dropdown-content">
                                ...
                                <a href="LichSuMuaHang.aspx"><i class="fa-solid fa-clock-rotate-left"></i> Lịch sử mua
                                    hàng</a>
                                <a id="linkQuanTri" runat="server" href="QuanTri.aspx" visible="false"><i
                                        class="fa-solid fa-gear"></i> Quản trị</a>
                                <a id="linkThongKe" runat="server" href="BaoCao.aspx" visible="false"><i
                                        class="fa-solid fa-chart-pie"></i> Thống kê</a>
                                <a href="DangNhap.aspx?logout=true" class="logout-link"><i
