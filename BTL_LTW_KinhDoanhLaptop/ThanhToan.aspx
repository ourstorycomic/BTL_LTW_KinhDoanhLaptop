<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThanhToan.aspx.cs"
    Inherits="BTL_LTW_KinhDoanhLaptop.ThanhToan" %>
    ...
    <body>
        <form id="form1" runat="server"
            style="display: flex; flex-direction: column; flex: 1; margin: 0; padding: 0; min-height: 100vh;">
            ...
            <main class="main-container flex-1"
                ...
                <div style="background: white; padding: 30px; border: 1px solid #e0e0e0; border-radius: 8px;">
                    <h2 style="margin-bottom: 25px; color: #333;" id="TieuDeTrang" runat="server">Thông tin đơn hàng
                    </h2>
                    ...
                    <div
                        style="display: flex; justify-content: flex-end; margin: 20px 0; padding-top: 15px; border-top: 2px solid #eee;">
                    ...
                    <div id="divThongTinKhachHang" runat="server"
                        ...
                        <h3
                            style="margin-bottom: 20px; color: #333; font-size: 18px; border-bottom: 1px solid #ddd; padding-bottom: 10px;">
                        ...
                        <h3
                            style="margin-top: 30px; margin-bottom: 20px; color: #333; font-size: 18px; border-bottom: 1px solid #ddd; padding-bottom: 10px;">
                        ...
                        <div id="divCardDetails"
                            ...
                            <p style="font-weight: bold; color: #333; margin-bottom: 15px;">Nhập thông tin thẻ thanh
                                toán:</p>
                            <div style="margin-bottom: 15px;">
                                <label style="display: block; font-weight: bold; margin-bottom: 5px;">Tên in trên
                                    thẻ:</label>
                            ...
                            <div style="display: flex; gap: 15px;">
                                <div style="flex: 1;">
                                    <label style="display: block; font-weight: bold; margin-bottom: 5px;">Ngày hết hạn
                                        (MM/YY):</label>
                                ...
                                <div style="flex: 1;">
                                    <label style="display: block; font-weight: bold; margin-bottom: 5px;">Mã
                                        CCV/CVV:</label>
                        ...
                        <script type="text/javascript">
                            function togglePaymentDetails() {
                                var rbl = document.getElementById('<%= rblPhuongThuc.ClientID %>');
                                if (!rbl) return;
                                ...
                                document.getElementById('divCardDetails').style.display = (selectedValue === 'CARD') ? 'block' : 'none';
                            }
                            ...
                            document.addEventListener("DOMContentLoaded", function () {
                                ...
                                if (rbl) {
                                    var inputs = rbl.getElementsByTagName('input');
                                    for (var i = 0; i < inputs.length; i++) {
                                        inputs[i].onclick = togglePaymentDetails;
                                    }
                                }
