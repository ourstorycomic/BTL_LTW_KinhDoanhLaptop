                    ...
                    <HeaderTemplate>
                        <table style="width:100%; border-collapse:collapse; margin-bottom: 20px;">
                            <tr style="background:#8bc34a; color:white;">
                                ...
                                <th style="padding:15px; border: 1px solid #ddd; text-align: center;">Thao tác</th>
                            </tr>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <tr style="text-align:center;">
                            <td style="padding:15px; border: 1px solid #ddd;">
                                <img src='<%# Eval("HinhAnh") %>' alt='<%# Eval("TenSanPham") %>' style="width: 80px; height: auto; object-fit: contain;" />
                            </td>
                            <td style="padding:15px; border: 1px solid #ddd;"><%# Eval("TenSanPham") %></td>
                            <td style="padding:15px; border: 1px solid #ddd;">
                              <div style="display: flex; align-items: center; justify-content: center; gap: 5px;">
                                <asp:TextBox ID="txtSoLuong" runat="server" Text='<%# Eval("SoLuong") %>' TextMode="Number" min="1" 
                     style="width: 60px; text-align: center; padding: 5px; border: 1px solid #ccc; border-radius: 4px;" />
                                <asp:LinkButton ID="btnCapNhat" runat="server" CommandName="CapNhat" CommandArgument='<%# Eval("MaSanPham") %>'
                        style="color: white; background-color: #2196F3; padding: 5px 10px; border-radius: 4px; text-decoration: none;"
                        ToolTip="Cập nhật số lượng">
                            ...
                            <td style="padding:15px; border: 1px solid #ddd; text-align: center;">
                                <asp:LinkButton ID="btnXoa" runat="server" CommandName="Xoa" CommandArgument='<%# Eval("MaSanPham") %>' style="color: red; font-weight: bold; text-decoration: none; padding: 5px 10px; border: 1px solid red; border-radius: 4px; display: inline-block;">
